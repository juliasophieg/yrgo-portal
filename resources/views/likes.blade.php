...
<div class="main">
    ...
    <div class="liked-page">
        ...
        <div class="cards-section">
            @if (count($likedUsers) <= 0) <div class="no-likes">Du har inte gillat några företag ännu, gå till vår
                <a href="{{ route('companies') }}">företagssida</a> för att hitta några
        </div>
        @else
    ...
    <div class="cards-section">
        @if (count($likedUsers) <= 0) <div class="no-likes">Du har inte gillat några studenter ännu, gå till vår
            <a href="{{ route('students') }}">studentsida</a> för att hitta några
    </div>
    @else
