<div class="company-profile">
    <div class="profile-header">
        ...
        <div class="profile-info">
            <div class="info">
                <input field="text" class="name company" id="name" name="name" value="{{ $user->name }}"
                    placeholder="Företagsnamn">
            </div>
            <!-- LOCATION -->
            <input field="text" class="location" id="location" name="location" value="{{ $extraInfo->location }}"
                placeholder="Storgatan 1, Göteborg">
        ...
        <div class="desktop-selection">
            ...
            <div class="main-section">
                ...
                @if ($user->description == null)
                    <textarea id="description" name="description" rows="4" class="form-control user-description"
                        placeholder="Här får ni gärna berätta lite mer om företaget (ex. antal LIA-platser, hur många ni är i teamet etc.)"></textarea>
                @else
