    ...
    <div class="gdpr-page">
        <div class="width-container">
            ...
            <div class="text-top">
                ...
                <p class="body">När du är klar kommer du att ha en biljett till evenemanget och även ett konto på
                    plattformen där du kan se andra företag och studenter som kommer att delta i evenemanget.</p>
            </div>
