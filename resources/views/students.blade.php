...
<div class="main">
    <div class="students-page">
        ...
        <div class="cards-section">
            @if (count($students) <= 0) Inga studenter jobbar med detta, testa en annan kategori eller färre. @else @foreach ($students as $student) <div class="student-card">
                <div class="image">
